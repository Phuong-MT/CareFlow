...
import { getAllEventsUserCanSee } from '@/store/eventSlide';
...
export default function EventsPageUser() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        await dispatch(getAllEventsUserCanSee({ tenantCode, page, limit } as EventRequest));
      } catch (error) {
